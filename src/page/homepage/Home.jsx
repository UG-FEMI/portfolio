            ...
            <div className='bg-white pb-[5px]'>
                <div className='container mx-auto pt-[50px] md:flex'>
                    <div className='w-full md:w-[50%] mt-[80px]'>
                        ...
                        <p className='text-[20px] w-full md:w-[80%] font-[400] py-5'>As a skilled Front-End developer, I am dedicated to turning ideas into innovative web applications.</p>
                    </div>
                ...
                <div className='text-center mt-[30px] mb-[50px]'>
                    <Link className='py-3 px-10 bg-[#6C63FF] w-[25%] font-[500] text-[white] rounded-tl-[10px] rounded-br-[10px]'>
                        Resume
                    </Link>
                </div>
            </div>
